...
import { Network, ArrowRight, CircleDot, BookOpen, ChevronLeft } from "lucide-react";
...
const adjacencyList: Record<string, string[]> = nodes.reduce((acc, node) => ({ ...acc, [node]: [] }), {} as Record<string, string[]>);
edges.forEach(([a, b]) => {
