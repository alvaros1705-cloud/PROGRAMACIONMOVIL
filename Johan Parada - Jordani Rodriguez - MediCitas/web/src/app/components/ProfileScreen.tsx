        ...
        <div className="text-center">
          <div className="relative inline-block mb-4">
            <Avatar className="h-24 w-24 border-4 border-white">
              <AvatarImage src="" />
              <AvatarFallback className="bg-purple-800 text-2xl">JP</AvatarFallback>
            </Avatar>
            <button className="absolute bottom-0 right-0 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg">
              <Camera className="w-4 h-4 text-purple-600" />
            </button>
          </div>
          <h1 className="text-2xl font-semibold">Juan Pérez García</h1>
          <p className="text-sm opacity-90 mt-1">usuario@ejemplo.com</p>
              ...
              <div className="p-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">+57 300 123 4567</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-gray-400" />
              </div>
              ...
              <div className="p-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">15 de Marzo, 1990</p>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-gray-400" />
              </div>
