import { Calendar, FileText, Pill, Home, User, Bell, Plus, Clock, MapPin, ChevronRight } from "lucide-react";
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            <Avatar className="h-12 w-12 border-2 border-white">
              <AvatarImage src="" />
              <AvatarFallback className="bg-blue-800">JP</AvatarFallback>
            </Avatar>
            <div>
              <p className="text-sm opacity-90">Bienvenido de nuevo</p>
              <h1 className="text-xl font-semibold">Juan Pérez</h1>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <CardContent className="p-4 text-center">
                ...
                <p className="text-xs text-purple-600 mt-2 font-medium">Camino mínimo</p>
              </CardContent>
            </Card>
          </div>
        </div>
